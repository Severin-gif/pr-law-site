    ...
    <section className="w-full bg-neutral-950 text-neutral-100">
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <p className="text-lg mb-6 text-neutral-300">
          Юридическая помощь, оказываемая на безвозмездной основе в отдельных
          случаях общественной или системной значимости.
        </p>
        ...
        <p className="mb-6 leading-relaxed text-neutral-200">
          ...
          Есть случаи, где профессиональная юридическая поддержка необходима вне
          стандартной коммерческой модели.
        </p>
        ...
        <ul className="space-y-3 mb-8 list-disc pl-6 text-neutral-300">
          ...
          <li>
            ситуации, где юридическая защита объективно необходима, а коммерческий
            формат затруднителен.
          </li>
        </ul>

        <p className="mb-10 text-neutral-400">
          Каждое обращение проходит предварительную юридическую оценку. Решение
          принимается индивидуально с учётом текущей загрузки.
        </p>
        ...
        <p className="text-neutral-200">
          ...
          с темой «Pro Bono» и кратким описанием ситуации.
        </p>
