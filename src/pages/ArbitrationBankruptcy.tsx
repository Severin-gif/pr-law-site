  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Юридическое сопровождение арбитражных споров и банкротства: процессуальная стратегия, защита интересов кредиторов и должников, контроль ключевых сроков."
        />
      </Helmet>
