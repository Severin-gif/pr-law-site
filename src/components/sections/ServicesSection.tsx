...
const ServicesSection = () => {
  return (
    <section id="services" className="py-14 sm:py-16 lg:py-20">
      ...
      <div className="mt-8 lg:hidden" aria-label="Услуги: мобильная карусель">
        <div className="flex snap-x snap-mandatory gap-4 overflow-x-auto pb-2 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
          {SERVICES.map((service) => (
            <div key={service.id} className="w-[88%] shrink-0 snap-start sm:w-[62%]">
      ...
      <div className="mt-10 hidden gap-5 lg:grid lg:grid-cols-3 lg:items-stretch">
        {SERVICES.map((service) => (
