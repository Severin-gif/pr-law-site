  ...
  () => [
    {
      ...
      text:
        "Юридический контроль хозяйственных операций и документов: проверка первичной документации на судебные риски, анализ договорных условий до подписания, подготовка модели взыскания дебиторской задолженности, сопровождение споров с налоговыми и иными контролирующими органами, формирование доказательной базы до возникновения судебного конфликта.",
      hint: "Юридический контроль первички",
    },
    {
      ...
      topic: "Запрос от АУ",
      text:
        "Подключение к сложным обособленным спорам: включение и оспаривание требований, анализ сделок должника, взыскание убытков, споры о субсидиарной ответственности, защита позиции при конфликте интересов сторон процедуры.",
      hint: "Сложные процессуальные споры",
    },
    {
      title: "Оценщикам",
      ...
      text:
        "Юридическая защита отчётов об оценке: работа с рецензиями, подготовка возражений, сопровождение судебных экспертиз, формирование правовой позиции в спорах, где стоимость актива является ключевым элементом доказательств.",
      hint: "Упаковка оценки в позицию",
    },
    {
      title: "Аудиторам",
      ...
      text:
        "Правовое сопровождение ситуаций, выявленных в ходе финансового анализа: корпоративные конфликты, ответственность руководителя, риски вывода активов, споры с контрагентами и контролирующими органами.",
      hint: "Переход от финансового риска к правовому",
    },
  ],
  []
);
